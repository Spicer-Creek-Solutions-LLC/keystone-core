...
// RotationPolicy is a v1.0 placeholder for the v1.4 rotation
...
// v1.0 → v1.4 line, and so the v0.x test suite has something concrete
...
//     health-check gates, auto-rollback — v1.4.
//   - Cron scheduling + Slack / PagerDuty notifications — v1.4.
//
...
type RotationPolicy struct {
	// Enabled toggles rotation. v1.0 only honours false; v1.4 wires
	// the strategies.
	Enabled bool `json:"enabled"`

	// Interval is the cadence the v1.4 cron scheduler will use. 0 in
	// v1.0; populated from config when the v1.4 features land.
	Interval time.Duration `json:"interval,omitempty"`

	// Strategy is free-form at v1.0 — the v1.4 work replaces it with
...
// rather than the bare struct literal, which is the same shape v1.4
