...
func TestSubjectBuilder_Patterns(t *testing.T) {
	...
	tests := []struct {
		...
		{b.AgentConverge("agent-7"), "kscore.prod.agent.agent-7.converge"},
		{b.AgentConvergeResult("agent-7"), "kscore.prod.agent.agent-7.converge.result"},
		{b.AgentConvergeResultPattern(), "kscore.prod.agent.*.converge.result"},
