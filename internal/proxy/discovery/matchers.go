...
func DefaultProfiles() []*DeviceProfile {
	return []*DeviceProfile{
		...
		// Check Point Gaia
		{
			...
			VendorPatterns:       []string{"Checkpoint", "Check Point"},
			SysDescrPatterns:     []string{"Gaia", "Check Point"},
			DeviceTypes:          []DeviceType{DeviceTypeFirewall},
			Priority:             100,
			SuggestedCredentials: []string{"ssh"},
			AdapterType:          "checkpoint-gaia",
		},
		// MikroTik RouterOS
		{
			Name:                 "mikrotik-routeros",
			Description:          "MikroTik RouterOS routers",
			VendorPatterns:       []string{"MikroTik"},
			SysDescrPatterns:     []string{"MikroTik", "RouterOS"},
			DeviceTypes:          []DeviceType{DeviceTypeRouter},
			Priority:             100,
			SuggestedCredentials: []string{"ssh"},
			AdapterType:          "mikrotik-routeros",
		},
		// Ubiquiti EdgeOS
		{
			Name:                 "ubiquiti-edgeos",
			Description:          "Ubiquiti EdgeOS routers",
			VendorPatterns:       []string{"Ubiquiti"},
			SysDescrPatterns:     []string{"EdgeOS", "EdgeRouter"},
			DeviceTypes:          []DeviceType{DeviceTypeRouter},
			Priority:             95,
			SuggestedCredentials: []string{"ssh"},
			AdapterType:          "ubiquiti-edgeos",
		},
		// Extreme EXOS
		{
			Name:                 "extreme-exos",
			Description:          "Extreme Networks EXOS switches",
			VendorPatterns:       []string{"Extreme"},
			SysDescrPatterns:     []string{"ExtremeXOS", "EXOS"},
			DeviceTypes:          []DeviceType{DeviceTypeSwitch},
			Priority:             90,
			SuggestedCredentials: []string{"ssh", "snmp"},
			AdapterType:          "extreme-exos",
		},
		// Nokia SR OS
		{
			Name:                 "nokia-sros",
			Description:          "Nokia SR OS routers",
			VendorPatterns:       []string{"Nokia"},
			SysDescrPatterns:     []string{"TiMOS", "SR OS"},
			DeviceTypes:          []DeviceType{DeviceTypeRouter},
			Priority:             90,
			SuggestedCredentials: []string{"ssh", "snmp"},
			AdapterType:          "nokia-sros",
		},
		// Huawei VRP
		{
			Name:                 "huawei-vrp",
			Description:          "Huawei VRP routers and switches",
			VendorPatterns:       []string{"Huawei"},
			SysDescrPatterns:     []string{"Huawei", "VRP"},
			DeviceTypes:          []DeviceType{DeviceTypeRouter, DeviceTypeSwitch},
			Priority:             90,
			SuggestedCredentials: []string{"ssh", "snmp"},
			AdapterType:          "huawei-vrp",
		},
		// Mellanox/NVIDIA Onyx
		{
			Name:                 "mellanox-onyx",
			Description:          "Mellanox/NVIDIA Onyx switches",
			VendorPatterns:       []string{"Mellanox", "NVIDIA"},
			SysDescrPatterns:     []string{"MLNX-OS", "Onyx"},
			DeviceTypes:          []DeviceType{DeviceTypeSwitch},
			Priority:             85,
			SuggestedCredentials: []string{"ssh"},
			AdapterType:          "mellanox-onyx",
		},
		// Allied Telesis AlliedWare Plus
		{
			Name:                 "alliedtelesis-awplus",
			Description:          "Allied Telesis AlliedWare Plus switches",
			VendorPatterns:       []string{"Allied Telesis"},
			SysDescrPatterns:     []string{"AlliedWare", "AT-"},
			DeviceTypes:          []DeviceType{DeviceTypeSwitch},
			Priority:             85,
			SuggestedCredentials: []string{"ssh", "snmp"},
			AdapterType:          "alliedtelesis-awplus",
		},
		// Ciena SAOS
		{
			Name:                 "ciena-saos",
			Description:          "Ciena SAOS switches",
			VendorPatterns:       []string{"Ciena"},
			SysDescrPatterns:     []string{"SAOS", "Ciena"},
			DeviceTypes:          []DeviceType{DeviceTypeSwitch},
			Priority:             85,
			SuggestedCredentials: []string{"ssh"},
			AdapterType:          "ciena-saos",
		},
		// Linux Server
		{
			Name:                 "linux-server",
		...
		// Windows Server
		{
			...
			DeviceTypes:          []DeviceType{DeviceTypeServer},
			Protocols:            []Protocol{ProtocolWinRM},
			Priority:             50,
		...
		// Generic Router
		{
			...
			DeviceTypes:          []DeviceType{DeviceTypeRouter},
			Protocols:            []Protocol{ProtocolSSH, ProtocolSNMP},
			Priority:             10,
			SuggestedCredentials: []string{"ssh", "snmp"},
			AdapterType:          "ssh",
		},
		...
		// Generic Firewall
		{
			...
			DeviceTypes:          []DeviceType{DeviceTypeFirewall},
			Protocols:            []Protocol{ProtocolSSH, ProtocolHTTPS},
			Priority:             10,
			SuggestedCredentials: []string{"ssh", "api"},
			AdapterType:          "ssh",
		},
...
func DefaultMatcher() *PatternMatcher {
	...
	for _, profile := range DefaultProfiles() {
		_ = matcher.AddProfile(profile) //nolint:errcheck // default profiles are valid
	}
	return matcher
}
