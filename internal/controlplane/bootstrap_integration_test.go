...
func (s managerSubjects) AgentCommand(agentID string) string {
	return s.m.Subjects().AgentCommand(agentID)
}
func (s managerSubjects) AgentHeartbeat() string       { return s.m.Subjects().AgentHeartbeat() }
func (s managerSubjects) AgentResponsePattern() string { return s.m.Subjects().AgentResponsePattern() }
func (s managerSubjects) BootstrapRegisterPattern() string {
	return s.m.Subjects().BootstrapRegisterPattern()
}
