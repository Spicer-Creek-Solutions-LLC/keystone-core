...
func TestLinuxProvider_AddSurfacesUseradd(t *testing.T) {
	t.Parallel()
...
func TestLinuxProvider_Mod_NoChangeSkipsCall(t *testing.T) {
	t.Parallel()
...
func TestLinuxProvider_Del_SurfacesUserdel(t *testing.T) {
	t.Parallel()
...
func TestLinuxProvider_SetGroups_SurfacesUsermod(t *testing.T) {
	t.Parallel()
...
func TestLinuxProvider_SetGroups_EmptySet(t *testing.T) {
	t.Parallel()
	p := linuxProvider{}
...
func TestLinuxProvider_Add_AllFlags(t *testing.T) {
	t.Parallel()
...
func TestLinuxProvider_Mod_AllScalarFlags(t *testing.T) {
	t.Parallel()
	p := linuxProvider{}
	uid := 99999
	gid := 99999
...
func TestLinuxProvider_Add_GroupByName(t *testing.T) {
	t.Parallel()
...
func TestLinuxProvider_Mod_GroupByName(t *testing.T) {
	t.Parallel()
	p := linuxProvider{}
	err := p.Mod(context.Background(), ModOptions{
		Name:  "zzz-no-such-user-zzz",
