...
// enrichment pipeline land in v1.1.
//
...
// audit (policy pass/violation, user actions), and v1.1 automation
...
//     downstream routing (the audit pipeline in epic 12, the v1.1
...
// gate-v1.0 / v1.1 buckets): reactor engine, event lifecycle
