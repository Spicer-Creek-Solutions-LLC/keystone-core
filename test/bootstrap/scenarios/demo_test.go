...
func TestDemoBootstrapScenario(t *testing.T) {
	...
	for _, platform := range platforms {
		...
		t.Run(platform.Name, func(t *testing.T) {
			...
			requireExecSuccess(t, result, "demo bootstrap dry-run")
			requireOutputContains(t, result.Stdout+result.Stderr, "package installation plan", "demo bootstrap output")
		})
	}
}
