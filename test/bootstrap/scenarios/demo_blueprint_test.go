...
func TestDemoBootstrapWithBlueprints(t *testing.T) {
	...
	for _, platform := range platforms {
		...
		t.Run(platform.Name, func(t *testing.T) {
			...
			requireExecSuccess(t, result, "demo bootstrap with blueprints")
			requireOutputContains(t, result.Stdout+result.Stderr, "blueprint blueprints/kscore/demo loaded", "demo blueprint output")
		})
	}
}
