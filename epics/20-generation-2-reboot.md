...
- [x] G35 — Check a merged document against what approved it. Git history records
  ...
  merge commit. The regression test starts at C01's original approval, proves
  G26 and G27's sanctioned edits pass, catches both verbatim G33 additions, and
  passes after the G34 correction is recorded. The current C01 snapshot is
  `028019924`.
