...
func TestIntegration_IdentityEventsEmission(t *testing.T) {
	...
	for _, evt := range identityLifecycle {
		...
		if err := env.eventBus.Publish(event); err != nil {
...
func TestIntegration_IdentityVerifiedExecution(t *testing.T) {
	...
	if err := env.eventBus.Publish(cmdRequestEvent); err != nil {
	...
	if err := env.eventBus.Publish(identityVerifyEvent); err != nil {
	...
	if err := env.eventBus.Publish(policyEvent); err != nil {
	...
	if err := env.eventBus.Publish(cmdExecuteEvent); err != nil {
...
func TestIntegration_IdentityFederation(t *testing.T) {
	...
	if err := env.eventBus.Publish(bundleReceivedEvent); err != nil {
	...
	if err := env.eventBus.Publish(trustEstablishedEvent); err != nil {
	...
	if err := env.eventBus.Publish(federatedVerifyEvent); err != nil {
	...
	if err := env.eventBus.Publish(federatedPolicyEvent); err != nil {
...
func TestIntegration_BootstrapIdentityLifecycle(t *testing.T) {
	...
	if err := env.eventBus.Publish(tokenGeneratedEvent); err != nil {
	...
	if err := env.eventBus.Publish(tokenUsedEvent); err != nil {
	...
	if err := env.eventBus.Publish(attestationEvent); err != nil {
	...
	if err := env.eventBus.Publish(svidIssuedEvent); err != nil {
	...
	if err := env.eventBus.Publish(agentRegisteredEvent); err != nil {
...
func TestIntegration_IdentityRevocation(t *testing.T) {
	...
	if err := env.eventBus.Publish(revocationInitEvent); err != nil {
	...
	if err := env.eventBus.Publish(crlUpdateEvent); err != nil {
	...
	if err := env.eventBus.Publish(policyDenyEvent); err != nil {
	...
	if err := env.eventBus.Publish(agentDisconnectEvent); err != nil {
