...
- **References**: `pkg/api/{agents,state,schedule,execution,maintenance}/handler.go` (five stub registrations); `docs/project/GETTING-STARTED.md` §4 footnote + §troubleshooting "Alternative: drive everything via REST"; `docs/project/PUBLIC-LAUNCH-CHECKLIST.md` D1 evidence F5.
