...
| C03 — NATS operator, account, identity and permission generation | [C03.md](C03.md) | C03-A's forty-five cases and C03-I's five stages landed — one § 3.2 output owed |
